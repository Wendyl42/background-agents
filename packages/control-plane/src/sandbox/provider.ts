 ...
 */
export interface SandboxStartupContext {
  /** Sandbox backend, distinct from the LLM provider. */
  sandboxBackend?: string;
  /** Control-plane create/restore/resume attempt, not a process boot identity. */
  startupAttemptId?: string;
}

export interface CreateSandboxConfig extends SandboxStartupContext {
 ...
 */
export interface RestoreConfig extends SandboxStartupContext {
 ...
 */
export interface ResumeConfig extends SandboxStartupContext {
...
/** Only confirmed artifact failures may invalidate a prebuilt image. */
export type SandboxErrorReason = "image_unavailable" | "backend_mismatch" | "unknown";
...
export class SandboxProviderError extends Error {
  constructor(
    ...
    public readonly reason: SandboxErrorReason = "unknown"
  ) {
    super(message);
