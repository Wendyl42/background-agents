...
| Key                 | Description                                                                                                                                  |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `ANTHROPIC_API_KEY` | Required only for Claude models; Modal injects it when configured through Terraform, while other providers use this global/repository secret |
